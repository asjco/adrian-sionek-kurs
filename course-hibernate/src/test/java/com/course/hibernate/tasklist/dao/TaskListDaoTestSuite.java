...
import com.course.hibernate.task.dao.TaskDao;
import com.course.hibernate.task.dao.TaskFinancialDetailsDao;
...
public class TaskListDaoTestSuite {
    ...
    private static final String LISTNAME = "Example list name";
